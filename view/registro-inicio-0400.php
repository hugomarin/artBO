	...
	<div class="row main-row">	
		<div class="panel nopadding">
			<div class="inner-header">
				...
				<h5>Hasta el 15 de mayo puede realizar su registro en este proceso. </h5>
				...
				<ul class="no-bullet">
					...
					<li class="thin">5. <strong>Tipo de stand:</strong> 63mt², 45mt² y 31.50mt². <a href="#">Consulte aquí más información.</a></li>
