						...
						<tr>
							<td>
								<div class="anterior left"><!-- anterior -->
									<a title="Registro Artistas" href="<?php echo APPLICATION_URL?>registro-artistas-0440.html" >Anterior</a>
								</div><!-- END anterior -->
							</td>
							<td>
							...
							<td>
								<div class="siguiente left"><!-- siguiente -->
									<a title="Registro Documentos" href="<?php echo APPLICATION_URL?>registro-documentos-0460.html">Siguiente</a>
								</div> <!-- END siguiente -->
							</td>
						</tr>
                        <?php 
