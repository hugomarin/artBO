			...
			<div class="inner-header">
				<div class="row">
					...
					<div class="four columns mini-nav-header">
						<dl class="sub-nav">
							<dd><a class="save" title="Guardar" href="javascript:void(0);" onclick="$('#validable2').attr('action','<?php echo APPLICATION_URL?>user.controller/createFeria/stay.html'); $('#validable2').submit();">Guardar</a></dd>
				...
				<div class="container">
					<div class="row">
						...
						<div class="four columns">
							<div class="right">
								<a href="<?php echo APPLICATION_URL?>registro-exposiciones-0420.html" title="Registro Ferias" class="graytxt">Anterior</a>  <a href="javascript:void(0);" onclick="$('#validable2').submit();" class="button radius">Siguiente: Artistas</a>
							</div>
						</div>
					</div>
				</div>
