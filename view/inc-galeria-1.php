...
?>
	...
	<div class="row">
		...
		<div class="six columns">
			...
			<p class="caption"><strong>Nota:</strong> Con este número de identificación también se registrará el ingreso de mercancía de sus obras, equipos y otros a Corferias.</p>
	...
	<div class="row">
		...
		<div class="six columns">
			<div class="mid-input review-data">
				...
				<p class="caption"><strong>Nota: </strong>Un breve texto (máximo 500 palabras) sobre la Galería</p>
	...
	<div class="row">
			...
			<div class="six columns">
				<div class="mid-input directorname-data">
					...
					<span class="caption">Nota: Si hay más de un director o persona de contacto, separe los datos con comas.</span>
