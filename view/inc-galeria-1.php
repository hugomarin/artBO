	...
	<div class="row">
		...
		<div class="six columns">
			...
			<div class="mid-input companyname-data">
				...
				<caption><strong>Nota:</strong> Con esta información se procederá a realizar la facturación correspondiente.</caption>
			...
			<div class="mid-input docnumber-data">
				...
				<caption><strong>Nota:</strong>Tenga en cuenta que con número de identificación, también se registrará el ingreso de mercancía de sus obras, equipos y otros a Corferias.</caption>
			</div><!--/companyname-data-->
	...
	<div class="row">
		...
		<div class="six columns">
			<div class="mid-input review-data">
				...
				<i>Un breve texto (máximo 500 palabras) sobre la Galería</i>
