...
$system_name = 'config_control_users';
//permissions
...
$pager = new Pager($_GET[0], '', '', 'index.php?user_list.control', 20, $users['num_rows'], $page); 
    ...
    <div id="mainContent">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th><a href="index.php?user_list.control/role_id">Rol</a></th>
                <th class="width80px"><a href="index.php?user_list.control/user_state">Estado</a></th>
                <th class="width50px"><a href="index.php?user_list.control/user_last_login">&Uacute;ltimo Ingreso</a></th>
                <th class="widthacciones">Acciones</th>
            </tr>
            <?php
            foreach($users as $user)
            {
				$role	= ($user->__get('role_id') != 0) ? new Role($user->__get('role_id')) : new Role(); 
				...
				$edit_link	   	= ($update !== false) 	? '<a href="index.php?user_expand.control/'.$user->__get('user_id').'">'.$user->__get('user_full_name').'</a>' : $user->__get('user_full_name');
            ...
            ?>
               <tr>
                    ...
                    <td><?php echo $role->__get('role_name') ?>
                    <td class="table01 width80px"><div id="u_state_<?php echo $user->__get('user_id')?>"><?php echo $state_display ?></div></td>
                    <td class="table01 width50px"><? echo formatDate('%d/%m/%Y', $user->__get('user_last_login')); ?></td>
