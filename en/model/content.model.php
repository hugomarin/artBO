<?php
	class Content extends Builder implements Crud 
	{
		public function __construct($id = NULL)
		{
			parent :: __construct();
			
			$this->table       = 'cont_contents';
			$this->identifyer  = 'content_id';
		...
		{
			$field = FieldHelper::getFieldName($this->objectArray["module_id"], $label);
