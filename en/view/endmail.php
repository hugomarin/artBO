...
$html			= '<div style="background: #f5f5f5; padding-bottom: 30px;margin-top: 0; width: 600px; font-family: Arial;"><div style="background: #9c1a36; padding: 10px 50px;"><img src="http://i.imgur.com/pUNnGGF.png" alt="artBO" /></div><div style="margin-top: 30px; padding: 10px 50px;"><h1 style="margin-bottom:30px;">You have completed your application</h1><p  style="margin-bottom:30px;">You have completed the registration process ArtBo 2013. <br />We appreciate your participation.</p><p>artBO, International Art Fair of Bogot&aacute;</p></div>
