...
$retrieveusuariosSql 	= "SELECT *  FROM user_users WHERE 1 = 1 ";
if ((isset($_POST['palabra'])) && ($_POST['palabra'] != ''))
	$retrieveusuariosSql	.= " AND user_name like '%".$_POST['palabra']."%' ";		
if ((isset($_POST['fecha_de'])) && ($_POST['fecha_de'] != ''))
	$retrieveusuariosSql	.= " AND user_creation_datetime >= '".$_POST['fecha_de']."' ";
if ((isset($_POST['fecha_de'])) && ($_POST['fecha_a'] != ''))
	$retrieveusuariosSql	.= " AND user_creation_datetime <= '".$_POST['fecha_a']."' ";	

$retrieveusuariosSql	.=  " ORDER by user_id ";
